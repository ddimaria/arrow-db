      ...
      >
        ...
        <div className="p-6">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-end space-y-2 sm:space-y-0 sm:space-x-3">
            ...
            <button
              type="button"
              className={`w-full sm:w-auto px-4 py-2 text-sm font-medium text-white rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors ${styles.confirmButton}`}
              onClick={onConfirm}
            >
              {confirmText}
            </button>
